...
const CREDENTIALS_WORKSPACE_PATH = path.join(process.cwd(), 'gmail_client_secret_workspace.json');
...
export class EmailService implements IEmailService {
    ...
    public async sendEmailConfirmationFromWorkspace(code: string, email: string): Promise<void> {
        const JWT = google.auth.JWT;
        const authClient = new JWT({
            keyFile: CREDENTIALS_WORKSPACE_PATH,
            scopes: SCOPES,
            subject: 'admin@orgemploy.com'
        });
